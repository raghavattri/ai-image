...
const API_TOKEN = "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";
...
const ImageGenerationForm = () => {
  ...
  return (<div className="imageGen">
    <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Browse through a collection of creative images by Stable diffusion</p>
      </div>
    ...
    {!loading && output && (
      <div className="result-image">
        <img src={output} alt="art" style={{width:"200px"}} />
        <div className="action">
            <button style={{color: "red",cursor: 'pointer'}} onClick={handleDownload}><FileDownloadIcon/></button>
            {user && <button style={{color: "red",cursor: 'pointer'}} onClick={uploadImage}><ShareIcon/></button>}
        </div>
      </div>
    )}
